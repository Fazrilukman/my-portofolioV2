    ...
    <AdminLayout activePage="projects">
                  ...
                  {project.category && (
                    <div className="mb-3">
                      <span className={`px-3 py-1 text-xs rounded-full font-medium ${
                        project.category === 'Project' ? 'bg-purple-500/20 text-purple-300' :
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 z-50 overflow-y-auto">
          <div className="bg-[#0a0428] border border-white/10 rounded-xl w-full max-w-3xl my-8">
              ...
              <div>
                ...
                <div className="flex gap-2 mb-2">
                  <label className="flex-1 cursor-pointer">
                    <div className="flex items-center justify-center gap-2 px-4 py-2 bg-indigo-500/20 hover:bg-indigo-500/30 text-indigo-400 rounded-lg transition-colors border border-indigo-500/30">
              ...
              <div>
                ...
                <div className="flex gap-2 mb-2">
                  ...
                  <button
                    type="button"
                    onClick={addFeature}
                    className="px-4 py-2 bg-indigo-500/20 hover:bg-indigo-500/30 text-indigo-400 rounded-lg transition-colors"
                  >
                    <Plus className="w-5 h-5" />
                  </button>
                </div>
