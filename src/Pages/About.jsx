  ...
  <div className="flex justify-end items-center sm:p-12 sm:py-0 sm:pb-0 p-0 py-2 pb-2">
    ...
    >
      ...
      <div className="absolute -inset-6 opacity-[25%] z-0 hidden sm:block">
        <div className="absolute inset-0 bg-gradient-to-r from-indigo-600 via-purple-500 to-blue-500 rounded-full blur-2xl animate-spin-slower" />
        <div className="absolute inset-0 bg-gradient-to-l from-purple-500 via-indigo-500 to-blue-600 rounded-full blur-2xl animate-pulse-slow opacity-50" />
        <div className="absolute inset-0 bg-gradient-to-t from-blue-600 via-purple-500 to-indigo-400 rounded-full blur-2xl animate-float opacity-50" />
      </div>

      <div className="relative">
        <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-full overflow-hidden shadow-[0_0_40px_rgba(99,102,241,0.3)] transform transition-all duration-700 group-hover:scale-105">
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Quote icon */}
        <div className="absolute top-3 left-4 text-indigo-500 opacity-30">
